...
class CelularWEB extends StatefulWidget {
  const CelularWEB({Key? key}) : super(key: key);

  @override
  _CelularWEBState createState() => _CelularWEBState();
}

class _CelularWEBState extends State<CelularWEB> {
  @override
